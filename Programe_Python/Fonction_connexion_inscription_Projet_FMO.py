...
import Class_interaction_sql_sur_DB_Projet_FMO as inter
...
def inscription(pseudo_inscrip : str, pasword : str, nom : str, premon : str):
    ...
    if pseudo_inscrip == user.rechercheBD("pseudo", pseudo_inscrip, "users", "pseudo"):
...
def connexion(pseudo_conex : str, pasword : str):
    ...
    if pseudo_conex != user.rechercheBD("pseudo", pseudo_conex, "users", "pseudo"):
